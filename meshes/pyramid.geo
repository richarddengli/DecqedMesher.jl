...
//+
Transfinite Curve {6, 1, 2, 7, 5, 3, 8, 4} = 2 Using Progression 1;
//+
Transfinite Surface {202} = {1, 5, 2};
//+
Transfinite Surface {203} = {2, 5, 3};
//+
Transfinite Surface {204} = {3, 5, 4};
//+
Transfinite Surface {201} = {4, 5, 1};
//+
Transfinite Surface {200} = {4, 1, 2, 3};
