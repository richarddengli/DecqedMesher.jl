...
export Interior_dualnodestruct, Boundary_dualnodestruct, Auxiliary_dualnodestruct, Interior_dualedgestruct, Boundary_dualedgestruct, Auxiliary_onprimaledge_dualedgestruct, Auxiliary_onprimalface_dualedgestruct, Interior_dualfacestruct, Boundary_dualfacestruct, Auxiliary_dualfacestruct, Dualvolumestruct, Dualnodedicts_struct, Dualedgedicts_struct, Dualfacedicts_struct, Dualmeshstruct
...
# the following two types both arise due to truncation of the dual mesh at the primal mesh boundary
# so in future unify/rename them
...
# so that each such boundary primal edge is divided into 2 such auxiliary dual edges;
